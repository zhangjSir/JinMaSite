...
?>
<div class="pad-lr-10">
<form name="searchform" action="?m=guestbook&c=guestbook&a=search_guestbook&menuid=<?php echo $_GET['menuid'];?>" method="post" >
...
<form name="myform" action="?m=guestbook&c=guestbook&a=delete" method="post" onsubmit="checkuid();return false;">
